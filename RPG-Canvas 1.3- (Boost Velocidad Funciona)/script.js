...
let ataquesJugador = ["Atq Normal", "Firaga I", "Hielo I", "Bio", "Coraza", "Prisa"];
...
function reducirSaludJugador(cantidad) {
  ...
  if(porcentajeDefJugador===100){
    ...
    dañoInfligidoPorRival= dañoInfligidoPorRival - ((dañoInfligidoPorRival*(porcentajeDefJugador-100))/100)
  }
  barSaludJugadorPrimero = Math.floor(Math.max(0,barSaludJugadorPrimero - dañoInfligidoPorRival));
...
function prisaJugador(){
  ...
  actualizarMsj(
    "¡" +
      pjJugadorPrimero +
      " usó " +
      ataquesJugador[5]+"!"+"<br>"+"¡Velocidad subió!"
  );
  activarPrisa();
}//--------------------------------------------------------------------------------------------------------------------------------------
...
console.log(`Velocidad de Jugador: ${velocidadJugador}`);
  console.log("------Estado:-------");
});
